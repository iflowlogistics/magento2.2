...
class Carrier extends AbstractCarrier implements CarrierInterface
{
    ...
    protected function _getRequestPayload(\Magento\Framework\DataObject $request)
    {
        ...
        $payload->address->number = $request->getRecipientAddressStreet1(); // # not necessarily available
        $payload->address->addressComplement = null; // SL "between_1"
        ...
        // $payload->address->comments = ; // source?
